      ...
      <div className="modal" style={{ maxWidth: '400px' }}>
        ...
        <div className="modal-body">
          ...
          {tab === 'login' ? (<div id="auth-login">
              ...
              <label className="form-label">Password</label>
              <input type="password" className="form-input" value={regPass} onChange={(e) => setRegPass(e.target.value)} placeholder="Create password"/>
